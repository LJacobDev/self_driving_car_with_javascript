class NeuralNetwork {
    ...
    static mutate(network, amount = 0.1) {
        ...
        //loop through each bias and then through each weight,
        //changing each by a slight random amount
        //to result in a network that is like another one
        //but slightly changed in new ways
